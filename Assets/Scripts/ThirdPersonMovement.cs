...
public class ThirdPersonMovement : MonoBehaviour
{
    ...
    {   
...

        {
            ...
            float targetAngle = Mathf.Atan2(direction.x,direction.z)*Mathf.Rad2Deg+cam.eulerAngles.y; //Pega Angulação entre os eixos
            float angle = Mathf.SmoothDampAngle(transform.eulerAngles.y,targetAngle, ref turnSmoothVelocity, turnSmoothTime);//Dados para Rotação suave
